...
<head>
    ...
    <link rel="Bookmark" href="/h-ui/img/favicon.ico">
    <link rel="Shortcut Icon" href="/h-ui/img/favicon.ico"/>
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/h-ui/lib/html5shiv.js"></script>
    <script type="text/javascript" src="/h-ui/lib/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="/h-ui/admin/h-ui/css/H-ui.min.css"/>
    <link rel="stylesheet" type="text/css" href="/h-ui/admin/h-ui.admin/css/H-ui.admin.css"/>
    <link rel="stylesheet" type="text/css" href="/h-ui/lib/Hui-iconfont/1.0.8/iconfont.css"/>
    <link rel="stylesheet" type="text/css" href="/h-ui/admin/h-ui.admin/skin/default/skin.css" id="skin"/>
    <link rel="stylesheet" type="text/css" href="/h-ui/admin/h-ui.admin/css/style.css"/>
    <!--[if IE 6]>
        ...
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="/wel" data-title="运营中心管理" href="javascript:void(0)">运营中心管理</a></li>
                    <li><a data-href="/wel" data-title="综合会员管理" href="javascript:void(0)">综合会员管理</a></li>
                    <li><a data-href="/wel" data-title="微圈代理管理" href="javascript:void(0)">微圈代理管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-customer">
            ...
            <dd>
                <ul>
                    <li><a data-href="/wel" data-title="客户列表" href="javascript:void(0)">客户列表</a></li>
...
<script type="text/javascript" src="/h-ui/admin/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="/h-ui/admin/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
